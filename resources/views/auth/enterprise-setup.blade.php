    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col col-lg-8">
                <div class="card">
                    <div class="card-header">Créer une entreprise</div>

                    <div class="card-body">
                        <form class="form-horizontal" enctype="multipart/form-data" method="POST"
                              action="{{ route('enterprise.register') }}" id="enterpriseform">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <p>Il se trouve que votre entreprise n'a jamais été créée. Vous pouvez donc entrer ses informations
                                    ici.</p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required
                                          form="enterpriseform">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group">
                                <label for="password-confirm">Pays</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input id="logo" name="logo" type="file" value="" required
    ...
    <script>
        $(document).ready(function() {
            $(".custom-file-input").change(function() {
                $("label.custom-file-label").html($(".custom-file-input").get(0).value.replace('C:\\fakepath\\', ''));
            });
        })
    </script>
@endsection